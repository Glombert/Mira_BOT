...
[![Version](https://img.shields.io/badge/version-1.4-brightgreen?style=for-the-badge)](https://github.com/Glombert/Mira_BOT)
...
Всего **18 инструментов**: `list_files`, `read_file`, `write_file`, `run_python`, `excel_read`, `excel_write`, `save_template`, `list_templates`, `list_self`, `recall`, `git_log`, `read_self`, `write_persona`, `write_agent_config`, `web_search`, `gdrive_list`, `gdrive_read`, `gdrive_write`.
