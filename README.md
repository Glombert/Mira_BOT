...
[![Version](https://img.shields.io/badge/version-1.1-brightgreen?style=for-the-badge)](https://github.com/Glombert/Mira_BOT)
...
- **Помнить** — структурированное резюме разговора (КТО/ПРОЕКТЫ/ФАКТЫ/ТЕКУЩЕЕ), профиль пользователя
...
| Память | JSON + структурированное резюме | ✓ |
...
[ ] v1.2      — Google Drive OAuth (личные аккаунты пользователей)
[ ] v1.x      — Тесты, ChromaDB (семантический поиск по истории)
```
